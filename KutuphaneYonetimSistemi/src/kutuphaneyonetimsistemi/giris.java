...
public class giris extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ComboBox_kadi.setBounds(250, 240, 172, 29);
        ...
        jButton1.setBounds(320, 340, 100, 30);
        ...
        txt_sifre.setBounds(250, 290, 172, 31);
    ...
    try{
        ...
        while(resultSet.next()){
            ...
            if(txt_sifre.getText().equals(kullaniciSifre))
            {
                ...
                else if(ComboBox_kadi.getSelectedItem().toString().equals("Personel"))
                {
                    Personel SK = new Personel();
                    this.setVisible(false);
                    SK.setVisible(true);
                    dispose();
                }
                ...
                {
                    JOptionPane.showMessageDialog(null,"Kullanıcı penceresine ulaşılamadı!","Kütüphane Yönetim Sistemi",0);
                }
            }
            else{
                JOptionPane.showMessageDialog(null,"Kullanıcı adı ya da şifre hatalı!","Kütüphane Yönetim Sistemi",0);
            }
        }
    }catch(Exception e){
